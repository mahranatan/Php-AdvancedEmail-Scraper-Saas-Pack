...
class admin extends Home
{
    ...
    */
    ...
    public function dashboard()
    {
        ...
        if(!empty($social_net_email)) {
            ...
            $not_where_social_net['where_in'] = array('search_in' => array('facebook.com','twitter.com','linkedin.com','pinterest.com','tumbler.com','reddit.com','flickr.com','instagram.com'));
        ...
        $where_unique = array('user_id'=>$user_id);
        ...
        $where_url = array('user_id'=>$user_id);
        ...
        $where_searchengine = array('user_id'=>$user_id);
        ...
        $where_unique_email = array('user_id'=>$user_id);
    ...
    */
	...
	public function decode_email_string(){
        ...
        $crud->order_by('id');
        $crud->set_subject('Decode Email String');
