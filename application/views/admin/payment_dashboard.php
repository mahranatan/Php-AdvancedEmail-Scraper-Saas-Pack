...
<div class="row" style="padding:10px;">
	...
	<div class="col-lg-4 col-xs-12 col-md-4">
		...
		<div class="small-box bg-aqua">
			<div class="inner">
				<h3><?php echo $total_paid_amount; ?></h3>
	...
	<div class="col-md-4 col-sm-6 col-xs-12">
		<div class="info-box" style="border:1px solid #F39C12;border-bottom:2px solid #F39C12;">
			...
			<div class="info-box-content">
				...
				<span class="info-box-number"><?php echo $this_month_paid_amount; ?></span>
			</div><!-- /.info-box-content -->
		</div><!-- /.info-box -->
	</div><!-- /.col -->
</div><!-- /.row -->
	...
	<div class="col-md-4 col-sm-6 col-xs-12">
		<div class="info-box bg-red">
			...
			<div class="info-box-content">
				...
				<span class="info-box-number"><?php echo $today_paid_amount; ?></span>
				<div class="progress">
					<div class="progress-bar" style="width: 70%"></div>
				</div>
				<span class="progress-description">
