	...
	<section class="content">  
		<div class="row">	
			<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3" style="background:#3399FF;margin-bottom:0px;margin-top:40px;padding-left:15px;padding-top:15px;">
				<h3 style="margin-top:0px !important;color:white"><i class="fa fa-binoculars"></i> Txt/XML/JSON Files Search Panel (Multiple)</h3>
			</div>	
...
$("#pull_data").click(function(e){
		...
		$.ajax({
            url: site_url+'admin_advance/multiple_read_file',
            type: 'POST',
            data: queryString,
            async: false,
            cache: false,
