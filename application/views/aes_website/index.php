...
<nav class="navbar navbar-default custom-navbar">
	<div class="custom-container">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand custom-brand" href="<?php echo site_url(); ?>"><img src="<?php echo site_url(); ?>aes_website/img/logo.png"  style="margin-top:10px;width:280px !important;" alt="<?php echo $this->config->item('product_name'); ?>"></a>
		</div>
				...
				<div class="carousel-inner" role="listbox">
					...
					<div class="item">
						...
						<div class="carousel-caption">
							<h3><?php echo $this->config->item('product_name'); ?></h3>
							<p><?php echo $this->config->item('product_name'); ?> is most powerful web based tool to extract emails by various techniques like website crawl, URL crawl, search in Google/Bing, search in txt file.It has ability to scrape encoded email.The ASCII encoded email can be decoded by this tool.Not only that by this tools can check email validation (pattern, MX record) , search for whois data, filter your email list by removing duplicate emails, check web page status .It is designed carefully so that you can install and use it very easily. </p>
							<br/><button type="button" class="btn btn-warning buy-it-now-btn">Read More</button>
						</div>
					</div>
					<div class="item">
						...
						<div class="carousel-caption">
							...
							<p>
								Crawl full website. Crawl bulk url , uploading it from txt/csv file. It can decrypt ecoded email. So no problem to scrape encryted email. 
							</p>
							<br/><button type="button" class="btn btn-warning buy-it-now-btn">Read More</button>
						</div>
					</div>
		...
		<div class="features-margin">
			...
			<div class="row">
				<div class="col-md-3 feature-margin animated wow slideInRight">
					...
					<p>
						Search email in doc /docx file. You can upload bulk doc /docx files and extract email from all doc /docx files. 
					</p>
				</div>
				...
				<div class="col-md-3 feature-margin animated wow slideInRight">
					...
					<p>
						Search email in JSON /  XML file. You can upload bulk JSON /  XML files and extract email from all JSON /  XML files. 
					</p>
				</div>
				...
				<div class="col-md-3 feature-margin animated wow slideInRight">
					...
					<p>
						Search email in text file. You can upload bulk text files and extract email from all text files. 
					</p>
				</div>
			</div>
			</div>
...
<section id="encrypted_section">
	<img src="<?php echo site_url(); ?>aes_website/img/encrypted.jpg" alt="encrypted"><br/>
</section>
...
<div class="container">
		<div class="row">
			<div class="col-xs-12 demotext">
				<br/><br/>
				<h2>
					<i class="fa fa-money"></i> Pricing 
				</h2>				
				<h3>
					$<?php echo $price; ?> / month  -  1 User 
				</h3>
				<br/><br/>
			</div> <!-- end col md -->
		</div> <!-- end row -->
