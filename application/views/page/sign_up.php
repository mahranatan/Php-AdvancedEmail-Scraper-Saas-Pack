	  			...
	  			<form class="form-horizontal" method="post" action="<?php echo site_url('home/sign_up_action'); ?>">
	  				...
	  				<div class="form-group">
	  					...
	  					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 input-group">
	  						...
	  						<input type="text" class="form-control right_border_radius" value="<?php echo set_value('address');?>" id="address" name="address" placeholder="Address *">	  						
	  					</div>
					...
					<div class="form-group">
	  					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 input-group">
	  						...
	  						<input type="text" class="form-control right_border_radius" value="<?php echo set_value('mobile');?>" id="mobile" name="mobile" placeholder="Mobile (With Country Code) *">
	  					</div>
